...
class ProductImageController extends Controller
{
     ...
     *
     * @Route("/{id}/images/add", name="ajax_product_add_image")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}/images/all", name="ajax_product_image")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}/delete", name="product_image_delete")
     * @Method("DELETE")
     */
     ...
     *
     * @Route("/{id}/edit", name="product_image_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, ProductImage $image)
    {
        ...
        return new JsonResponse([
            "success" => false, 
            "data" => $this->container->get('templating')->render('@App/product/partials/editImage.html.twig', array(
                'image' => $image,
