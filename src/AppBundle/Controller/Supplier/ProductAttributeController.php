...
class ProductAttributeController extends Controller
{
     ...
     *
     * @Route("/{id}/ajax", name="supplier_ajax_product_attribut_all")
     * @Method("GET")
     */
    public function ajaxAll(Product $product)
    {
        ...
        foreach($products as $item) {
            $arrayCollection[] = array(
                ...
                'attributs' => '',
                'action' => '
                    <a class="btn btn-success addEditDelinaison "  href="#" data-title="Modifer une declinaison"  data-url="'.$this->generateUrl('supplier_productattribute_edit', ['id' => $item->getId()]).'"><i style="color:#fff" class="fa fa-pen"></i></a>
                    <a data-url="'.$this->generateUrl('supplier_productattribute_delete', ['id' => $item->getId()]).'" href="#"  class="btn btn-danger deleteDelinaison" ><i style="color:#fff" class="fa fa-trash"></i></a>
                '
            );
        }
     ...
     *
     * @Route("/{id}/new", name="supplier_productattribute_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, Product $product)
    {
        ...
        return new JsonResponse([
            "success" => false, 
            "data" => $this->container->get('templating')->render('@App/supplierAccount/pages/product/productattribute/new.html.twig', array(
     ...
     *
     * @Route("/{id}/edit", name="supplier_productattribute_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, ProductAttribute $productAttribute)
    {
        ...
        return new JsonResponse([
            "success" => false, 
            "data" => $this->container->get('templating')->render('@App/supplierAccount/pages/product/productattribute/edit.html.twig', array(
                'productAttribute' => $productAttribute,
     ...
     *
     * @Route("/{id}/delete", name="supplier_productattribute_delete")
     * @Method("DELETE")
     */
